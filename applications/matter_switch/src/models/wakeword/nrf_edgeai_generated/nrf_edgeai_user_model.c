...
#define EDGEAI_LAB_SOLUTION_ID_STR	"92597"
...
#define P_MODEL_INSTANCE &model_axon_user_instance_92597
...
nrf_edgeai_t *nrf_edgeai_user_model_92597(void)
{
	return &nrf_edgeai_;
}
...
uint32_t nrf_edgeai_user_model_neuton_size_92597(void)
{
