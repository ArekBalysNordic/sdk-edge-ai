...
#define MATTER_DM_AMBIENT_CONTEXT_SENSING_CLUSTER_SERVER_ENDPOINT_COUNT			   (1)
...
// Use this macro to check if the server side of the Ambient Context Sensing cluster is included
#define ZCL_USING_AMBIENT_CONTEXT_SENSING_CLUSTER_SERVER
#define MATTER_DM_PLUGIN_AMBIENT_CONTEXT_SENSING_SERVER
#define MATTER_DM_PLUGIN_AMBIENT_CONTEXT_SENSING
